...
| Cut | Use |
|---|---|
| at this point in time / at this juncture | now |
...
| endeavor | try |
| obtain | get |
| individual (as noun) | person, man, woman |
| remainder | rest |
| initial | first |
...
| utilization | use |
| optimization | improvement (or name what improved) |
...
- In a sense
- On a personal note
- To be honest / honestly / frankly speaking
...
- best-in-class
- world-class
- cutting-edge / state-of-the-art (unless literally true and specified)
- next-level
- game-changing / disrupt / disruption
...
- "X's finest" ("New York's finest")
- "upcoming" (as adjective)
- "famed [profession]" ("famed diplomat")
- "noted [profession]"
- "veteran [profession]"
- "the embattled X"
- "the beleaguered Y"
...
- nodded in agreement → nodded
- shrugged his shoulders → shrugged

## Adjectives That State a Known Fact
